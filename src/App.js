...
class App extends Component {
    ...
    getValue (e) {
        ...
        $input.onkeyup = function() {
            ...
            timeout = setTimeout(function () {
                ...
                const movies = fetch(`https://api.themoviedb.org/3/search/multi?api_key=c6fd03a8cc77bd746f6a722cbd929d9e&query=${value}`);
    ...
    getMovies (e) {
        ...
        const movies = fetch(`https://api.themoviedb.org/3/person/${actorId}/movie_credits?api_key=c6fd03a8cc77bd746f6a722cbd929d9e`);
        movies
            .then(movie => movie.json())
            .then(movie => {
                this.setState({
